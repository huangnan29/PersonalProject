...
public class DateTime implements Serializable {
    ...
    public static final String DEFAULT_DATE_TIME_FORMAT_NO_SEPARATER = "yyyyMMddHHmmss";

    public static final String DEFAULT_BD_DATE_TIME = "200601010000000";

    public static final SimpleDateFormat SIMPLEDATEFORMAT = new SimpleDateFormat(DEFAULT_DATE_TIME_FORMAT_NO_SEPARATER);
    ;


    public static String getNWandSOW(String time) throws ParseException {

        long nw = 1000 * 24 * 60 * 60 * 7;
        long ns = 1000;

        // 获得两个时间的毫秒时间差异
        long diff = SIMPLEDATEFORMAT.parse(time).getTime() - SIMPLEDATEFORMAT.parse(DEFAULT_BD_DATE_TIME).getTime();


        //计算周计数
        long week = diff / nw;
        //计算周内秒
        long second = diff % nw / ns;

        //
        System.out.println(String.format("%04d", week) + "周计数" + String.format("%06d", second) + "周内秒");
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(df.format(new Date()) instanceof String);
        System.out.println(df2.format(new Date()));// new Date()为获取当前系统时间

        String start = "1990-01-10 12:12:12";
        String end = "1991-04-05 15:13:19";

        String start1 = "19900110121212";
        String start2 = "20190110121212";
        String end1 = "19910405151319";
//        SimpleDateFormat startFormat = new SimpleDateFo-mat(start);
//        SimpleDateFormat endFormat = new SimpleDateFormat(end);

        Date stf = df2.parse(start1);
        Date edf = df2.parse(end1);

        Date st2f = df2.parse(start2);
